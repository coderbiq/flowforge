...
| Status | ID | Title |
|--------|----|-------|
| ✅ done | flowforge-cbe.1.1 | 分析 Schema 层 status 字段的完整影响范围 |
| ✅ done | flowforge-cbe.1.2 | 分析 CLI context 脚本中 status 依赖的重构方案 |
| ✅ done | flowforge-cbe.1.3 | 分析 SKILL 描述中 status 引用及更新策略 |
| ✅ done | flowforge-cbe.1.4 | 分析 AGENTS.md 模板和指南文档中的 status 引用 |
| ✅ done | flowforge-cbe.1.5 | 分析 CLI proposal 操作脚本中的 status 处理 |

## 设计 (4 tasks, 4 done)

| Status | ID | Title |
|--------|----|-------|
| ✅ done | flowforge-cbe.2.1 | 设计 Schema 层 status 移除方案 |
| ✅ done | flowforge-cbe.2.2 | 设计 CLI context 脚本重构方案 |
